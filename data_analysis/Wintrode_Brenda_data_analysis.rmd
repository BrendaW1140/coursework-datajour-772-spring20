...
#Since the coronovirus pandemic outbreak hit America, the lack of a national testing strategy has put the responsibiltiy on each state to carry out their own.  Countries such as Iceland, South Korea and Thailand have managed to test wide swaths of their population in short amounts of time, and in doing so, have contained the spread and asymptomatic positive cases.

#My data analysis will find the percentage of the population that has been tested for 26 states and the District of Columbia. I will look for outlier states and examine further what may have happened and why.
