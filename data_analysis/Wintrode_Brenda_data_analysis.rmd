...
## Loading Libraries and Installing Needed Packages
...
##Loaded and cleaned The Covid Tracking Project API and U.S. Census Data and cleaned
...
state_population_working <- state_population %>%
 ...
 filter(!(state %in% c("ME","PA","DE")))
  
``` 
##Inner Join to Calculate Tests Per Capita
